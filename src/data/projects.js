...
const projects = [
  ...
  },
  {
    ...
    year: 2024,
    description:
      "A 24 page zine created as a follow on to a wider highlining project",
    badges: ["DESIGN", "PHOTOGRAPHY"],
    gridLayout: 2,
    imageStack: hlzines,
    home: true,
    projects: true,
  ...
  },
  {
    ...
    year: 2024,
    description:
      "Photography for Lock Holds to showcase their Supernova Series",
    badges: ["DESIGN", "PHOTOGRAPHY"],
    gridLayout: 3,
    imageStack: locksnvs,
    home: false,
