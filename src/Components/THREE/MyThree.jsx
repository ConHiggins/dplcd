  ...
  return (
    < div style={{pointerEvents:"none"}}>
        ...
        <div ref={refContainer}>
            ...
            <video ref={textureVid1} type="video/mp4" id="video" crossOrigin='true' playsInline muted webkit-playsinline="true" loop allow="auotplay" width="0" height="0"  style={{opacity:0}}>
                <source src={side1} />
            </video>
            <video ref={textureVid2} type="video/mp4" id="video2" crossOrigin='true' playsInline muted webkit-playsinline="true" loop allow="auotplay" width="0" height="0"  style={{opacity:0}}>
                <source src={side2} />
            </video>
            <video ref={textureVid3} type="video/mp4" id="video3" crossOrigin='true' playsInline muted webkit-playsinline="true" loop allow="auotplay" width="0" height="0"  style={{opacity:0}}>
                <source src={side3} />
            </video>
            <video ref={textureVid4} type="video/mp4" id="video4" crossOrigin='true' playsInline muted webkit-playsinline="true" loop allow="auotplay" width="0" height="0"  style={{opacity:0}}>
                <source src={side4} />
            </video>
            <video ref={textureVid5} type="video/mp4" id="video5" crossOrigin='true' playsInline muted webkit-playsinline="true" loop allow="auotplay" width="0" height="0"  style={{opacity:0}}>
                <source src={side5} />
            </video>
            <video ref={textureVid6} type="video/mp4" id="video6" crossOrigin='true' playsInline muted webkit-playsinline="true" loop allow="auotplay" width="0" height="0"  style={{opacity:0}}>
                <source src={side6} />
            </video>            
    </div>
  );
